...
pub fn builtin_presets() -> Vec<(&'static str, ThemeColors)> {
    vec![
        ...
        (
            ...
            ThemeColors {
                primary: "#b7bdf8".into(),
                primary_hover: "#8aadf4".into(),
                accent: "#c6a0f6".into(),
                accent_hover: "#7dc4e4".into(),
                bg: "#24273a".into(),
                surface: "#363a4f".into(),
                input: "#1e2030".into(),
                text: "#cad3f5".into(),
                text_muted: "#a5adcb".into(),
                border: "#494d64".into(),
                text_dim: "#8087a2".into(),
                text_on_primary: "#24273a".into(),
                btn_disabled: "#5b6078".into(),
                status_pending: "#eed49f".into(),
                status_active: "#8bd5ca".into(),
                status_completed: "#6e738d".into(),
                status_error: "#ed8796".into(),
                status_expired: "#8087a2".into(),
                type_ssh_bg: "#494d64".into(),
                type_ssh_fg: "#a6da95".into(),
                type_rdp_bg: "#494d64".into(),
                type_rdp_fg: "#f5a97f".into(),
                type_vnc_bg: "#494d64".into(),
                type_vnc_fg: "#c6a0f6".into(),
                type_web_bg: "#494d64".into(),
                type_web_fg: "#8aadf4".into(),
                type_vdi_bg: "#494d64".into(),
                type_vdi_fg: "#8bd5ca".into(),
                hop_bg: "#494d64".into(),
                hop_fg: "#a6da95".into(),
                bg_pattern: "none".into(),
            },
